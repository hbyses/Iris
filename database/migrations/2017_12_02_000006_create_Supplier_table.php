...
class CreateSupplierTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($this->set_schema_table, function (Blueprint $table) {
            ...
            $table->string('addressStreetNumber', 45)->nullable();
            $table->string('addressStreet', 100)->nullable();
            $table->string('addressSuburb', 45)->nullable();
            $table->string('addressState', 45)->nullable();
            $table->string('addressPostcode', 45)->nullable();
            $table->string('addressCountry', 100)->nullable();
